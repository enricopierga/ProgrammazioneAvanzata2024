...
router.patch('/:id/:gateId', requireAuthentication("Operatore"), GateController.update);
router.delete('/:id/:gateId', requireAuthentication("Operatore"),GateController.delete);
